...
export default function TarjetaExpandible({
  ...
  // useCallback para estabilizar la referencia y poder incluirla en el useEffect de abajo
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: e instanceof Error ? e.message : "Ocurrió un error inesperado.",
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className={`relative flex flex-col no-scrollbar transition-all duration-300 ${arActivo

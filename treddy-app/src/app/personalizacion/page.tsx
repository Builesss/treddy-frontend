                      ...
                      <div className="flex items-center justify-center w-full h-14 px-4 transition bg-[#0A0F2C] border-2 border-dashed border-cyan-500/30 rounded-xl group-hover:border-cyan-500 group-hover:bg-[#0F173A]">
                        {subiendoImagen ? (
                          ...
                          <div className="flex items-center space-x-2 text-[#B5B8C5] group-hover:text-cyan-400 transition-colors">
                            ...
                            <span className="font-medium text-sm">Adjuntar imagen</span>
                          </div>
                        )}
                  ...
                  {modelUrl && (
                    <div className="flex flex-col gap-3">
                      ...
                      <button
                        ...
                        disabled={agregando || !imagenReferenciaUrl}
                        className="w-full py-4 bg-gradient-to-r from-cyan-500 to-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-black font-bold rounded-xl transform hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all duration-200 flex items-center justify-center gap-2"
                      >
                        {agregando ? (
                          <>
                      ...
                      {!imagenReferenciaUrl && (
                        <p className="text-xs text-amber-400/80 text-center flex items-center justify-center gap-1.5">
                          ...
                          Debes adjuntar una imagen de referencia para continuar
                        </p>
                      )}
                    </div>
                  )}

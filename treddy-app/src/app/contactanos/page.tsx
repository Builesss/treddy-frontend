...
export default function ContactanosPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simular envío de formulario (aquí conectarías con tu API)
    setTimeout(() => {
    ...
    <main className="min-h-screen bg-[#0A0F2C] text-white">
      ...
      <section className="mx-8 mt-10 px-8 py-16 bg-[#0F173A]/20 rounded-2xl shadow-2xl backdrop-blur-md flex flex-col items-center text-center">
        ...
        <p className="mt-5 text-lg text-[#B5B8C5] max-w-2xl">
          ¿Tienes preguntas o necesitas ayuda? Estamos aquí para ti. Envíanos un mensaje y te responderemos lo antes posible.
        </p>
      </section>
      ...
      <div className="mx-8 my-16 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <section className="bg-[#10193F] p-8 rounded-2xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="nombre" className="block text-sm font-medium text-[#B5B8C5] mb-2">
                Nombre completo
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#B5B8C5] mb-2">
                Correo electrónico
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="asunto" className="block text-sm font-medium text-[#B5B8C5] mb-2">
                Asunto
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="mensaje" className="block text-sm font-medium text-[#B5B8C5] mb-2">
                Mensaje
              </label>
              <textarea
                id="mensaje"
        ...
        <section className="space-y-6">
          ...
          <div className="bg-[#10193F] p-8 rounded-2xl shadow-lg">
            ...
            <div className="flex gap-4">
              ...
              >
                <svg className="w-6 h-6 group-hover:text-black" fill="currentColor" viewBox="0 0 24 24">
